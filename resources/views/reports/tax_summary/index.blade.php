...
@section('new_button')
<span class="new-button"><a href="{{ url('reports/balance-summary') }}?print=1&status={{ request('status') }}&year={{ request('year', $this_year) }}" target="_blank" class="btn btn-success btn-sm"><span class="fa fa-print"></span> &nbsp;{{ trans('general.print') }}</a></span>
@endsection
...
<div class="box box-success">
    <div class="box-header with-border">
        {!! Form::open(['url' => 'reports/balance-summary', 'role' => 'form', 'method' => 'GET']) !!}
